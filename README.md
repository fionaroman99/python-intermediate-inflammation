# Inflam
![Continuous Integration build in GitHub Actions](https://github.com/fionaroman99/python-intermediate-inflammation/actions/workflows/main.yml/badge.svg?branch=main)
...
this README file is not complete, more information is still needed. Specifically, it needs info about:
installation, basic usage, contributing, contact information, credits, citation and licence.
